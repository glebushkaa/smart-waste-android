...
import ua.glebm.smartwaste.domain.usecase.bucket.IncreaseBucketItemCountUseCase.Params
...
class IncreaseBucketItemCountUseCase @Inject constructor(
    ...
    override suspend fun invoke(params: Params) = runCatching {
        withContext(Dispatchers.IO) {
            bucketRepository.increaseItemCount(params.name)
        }
    }
